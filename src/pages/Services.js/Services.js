    ...
    <div className="flex flex-col md:flex-row justify-around items-center p-10 space-y-6 md:space-y-0 md:space-x-6">
      <div className="bg-green-100 p-6 rounded-lg shadow-md w-full md:w-1/3 flex flex-col items-center">
        ...
        <p className="text-gray-700 text-center">
          We create robust and scalable Android applications tailored to your
          business needs.
        </p>
      </div>
      <div className="bg-blue-100 p-6 rounded-lg shadow-md w-full md:w-1/3 flex flex-col items-center">
        ...
        <p className="text-gray-700 text-center">
          Our web development team builds responsive and user-friendly websites
      ...
      <div className="bg-yellow-100 p-6 rounded-lg shadow-md w-full md:w-1/3 flex flex-col items-center">
        ...
        <p className="text-gray-700 text-center">
          We provide expert tech consulting services to help you navigate the
