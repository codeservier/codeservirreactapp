...
import backgroundImage from "../../assets/svgfiles/frame.svg"; 
...
const LandingPage = () => {
  ...
  const getSlideContent = (index) => {
    const content = [
      "Empowering Businesses with Cutting-Edge IoT Technology for Seamless Integration.",
      "Android Development: Building mobile apps for Android.",
      "Securing the future by protecting your connected devices with advanced IoT security solutions.",
      "Empowering your skills with comprehensive training in DSA, development, and cutting-edge IoT security solutions.",
      "Ensuring robust performance with expert training in DSA, development, and IoT security maintenance."
    ];
    return content[index] || "Content not available.";
  };
      ...
      <div className="flex flex-col lg:flex-row w-full md:px-8 lg:-mt-20 mt-10 rounded-lg overflow-hidden container mx-auto">
        <div className="flex flex-col justify-center w-full lg:mb-0 lg:px-20">
          ...
          <button
            ...
            className="w-full lg:w-[12rem] mt-6 md:mt-0 bg-gradient-to-r z-50 from-yellow-400 to-sky-400 text-white font-semibold px-6 py-3 rounded-full shadow-lg hover:shadow-xl 
            hover:bg-gradient-to-l transition duration-300 ease-in-out transform hover:scale-105"
          >
            Get In Touch
          </button>
        </div>

        <div className={`relative max-w-screen-2xl p-4 lg:p-8 overflow-hidden ${entering ? "slide-enter" : ""}`}>
          <img
